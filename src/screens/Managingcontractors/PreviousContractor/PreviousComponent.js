          ...
          <View style={PreviousComponentStyle.imageview}>
            ...
            <View style={{flex: 1, marginHorizontal: 15}}>
              <View style={PreviousComponentStyle.namebindview}>
                <Text style={PreviousComponentStyle.Jasontext}>
                  {props.name}
                </Text>
                {props.verified ? (
                  <View style={PreviousComponentStyle.verifirdview}>
                    ...
                    />
                    <Text style={PreviousComponentStyle.verifiedtext}>
                      verified
                    </Text>
                  </View>
                ) : null}
              ...
              <View>
                <Text style={PreviousComponentStyle.userName}>
                  {props.filedname}
                </Text>
                ...
                <View style={PreviousComponentStyle.iconbindview}>
                  ...
                  />
                  <Text style={PreviousComponentStyle.text1234}>
                    {props.address}
                  </Text>
                </View>
              </View>
