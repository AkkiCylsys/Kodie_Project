...
import {SignUpVerificationStyle} from './FacebookEmailVerifyStyle';
...
const CELL_COUNT = 6;
export default FacebookEmailVerify = props => {
  ...
  let _user_key = props?.route?.params?.user_key;
  let _FacebookuserInfo = props?.route?.params?._socialuserInfo;
  let password = props?.route?.params?.password;
  console.log("OTPverifyemail",email)
  console.log("_user_key",_user_key)
      ...
      .then(responseData => {
        ...
        if (responseData?.success === true) {
          ...
          props.navigation.navigate('SignUpSteps', {
            ...
            user_key: _user_key,
            password: password,
            _FacebookuserInfo:_FacebookuserInfo
          });
          //alert(user_key)
        } else {
