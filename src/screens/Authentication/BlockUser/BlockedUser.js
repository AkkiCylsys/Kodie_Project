        ...
        return (
            <>
                <View style={BlockedUserstyle.container}>
                    ...
                    <TouchableOpacity style={[BlockedUserstyle.ArrowIcon, { borderColor: item.IsBlock ? _COLORS.Kodie_GreenColor : _COLORS.Kodie_BlackColor }]}>
                        <Text style={[BlockedUserstyle.profile_SubHeading, { color: item.IsBlock ? _COLORS.Kodie_GreenColor : _COLORS.Kodie_BlackColor }]}>
    ...
    const ListHeader = () => {
        return (
            <View style={BlockedUserstyle.shareMainView}>
                <Text style={BlockedUserstyle.AllcontactsText}>
                    Blocked Users
                </Text>
            </View>
        );
    ...
    return (
        <View style={BlockedUserstyle.mainContainer}>
            ...
            <View style={BlockedUserstyle.addnewView}>
                <Text style={BlockedUserstyle.AddNew_Text}>
                    {"Add new..."}
                </Text>
            ...
            <Text style={BlockedUserstyle.bottomText}>
                Blocked users will no longer be able to send you messages,
                or be able to to see your interactions on Kodie.
            </Text>
