        ...
        return (
            <>
                <View style={SearchUserStyle.container}>
                    ...
                    <TouchableOpacity style={[SearchUserStyle.ArrowIcon,{borderColor:item.IsBlock?_COLORS.Kodie_GreenColor:_COLORS.Kodie_MediumGrayColor}]}>
                        <Text style={[SearchUserStyle.profile_SubHeading,{color: item.IsBlock?_COLORS.Kodie_GreenColor:_COLORS.Kodie_MediumGrayColor}]}>
    ...
    const ListHeader = () => {
        return (
            <View style={SearchUserStyle.shareMainView}>
                <Text style={SearchUserStyle.AllcontactsText}>
                    All Contacts
                </Text>
            </View>
        );
    ...
    return (
        <View style={SearchUserStyle.mainContainer}>
            ...
            <View style={SearchUserStyle.searchandShareMainView}>
                <SearchBar placeholder="Search contacts" backSearchIcon={true} height={48} marginTop={20} />
