...
export default FirstProperty = (props) => {
  ...
  const handleSaveSignupfill = async () => {
    ...
    formData.append("location_longitude", null);
    formData.append("location_latitude", null);
    formData.append("p_state", null);
    formData.append("p_country", null);
    formData.append("p_city", null);
    formData.append("islocation", 1);
    formData.append("property_description", null);
    formData.append("property_type", null);
    formData.append("key_features", null);
    formData.append("land_area", null);
    formData.append("floor_size", null);
    formData.append("device_id", deviceId);
    formData.append("device_type", deviceType);
    formData.append("additional_features", null);
