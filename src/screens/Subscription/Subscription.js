...
const ITUNES_SHARED_SECRET = '5358af94438340c9987d2858af937972';
...
export const Subscriptions = props => {
  ...
  //     console.error('Error in handleGetPurchaseHistory:', error);
  //   }
  // };
  const handleGetPurchaseHistory = async () => {
    try {
      ...
      if (error instanceof Error) {
        // Check if the error has a specific code or message
        if (error.code === 'E_NETWORK_ERROR') {
          console.error(
            'Network error occurred. Please check your internet connection.',
          );
        } else {
          console.error('An unknown error occurred. Details:', error.message);
          // Log the full error object for further analysis
