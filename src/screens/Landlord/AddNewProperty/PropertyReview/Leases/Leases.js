          ...
          <View style={LeaseSummaryStyle.paid_Date_View}>
            ...
            <Text style={LeaseSummaryStyle.Amount_Text}>
              {item.PLD_PAYMENT_DATE
                ? moment(item.PLD_PAYMENT_DATE.substring(0, 10)).format(
                    'Do MMMM YYYY',
                  )
                : ''}
            </Text>
    ...
    <>
                  ...
                  <View style={LeaseSummaryStyle.summary_view}>
                    <View>
                      ...
                      <Text style={LeaseSummaryStyle.date_cld_Text}>
                        {moment(leaseSummaryData?.NEXT_PAYMENT_DATE).format(
                          'dddd D MMMM YYYY',
                        )}
                      </Text>
                    </View>
                ...
                <View style={LeaseSummaryStyle.Lease_Term_main_View}>
                    ...
                    <View>
                      ...
                      <View style={LeaseSummaryStyle.sub_View}>
                        <Text style={LeaseSummaryStyle.date_Text}>
                          {moment(
                            leaseSummaryData?.UPLD_COMMENCEMENT_DATE,
                          ).format('D MMM YYYY')}
                        </Text>
                        <Text style={LeaseSummaryStyle.date_Text}>-</Text>
                        <Text style={LeaseSummaryStyle.date_Text}>
                          {moment(leaseSummaryData?.UPLD_LEASE_END_DATE).format(
                            'D MMM YYYY',
                          )}
                        </Text>
                      </View>
                  ...
                  <View style={LeaseSummaryStyle.summary_view}>
                    <View style={LeaseSummaryStyle.freq_View}>
                      ...
                      <Text style={LeaseSummaryStyle.date_Text}>
                        {leaseSummaryData?.UPLD_RENTAL_PAYMENT_FREQUENCY}
                      </Text>
                    </View>
                    <TouchableOpacity
      ...
      <RBSheet
        ...
        <Logrentalpayment
          ...
          lease_keys={leaseSummaryData?.LEASE_KEY}
          property_id={property_id}
        />
      </RBSheet>
