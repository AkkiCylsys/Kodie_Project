...
import { ArchivePropertiesStyle } from "./ArchivePropertiesStyle";
...
const HiddenItemWithActions = (props) => {
  ...
  return (
    <Animated.View
      style={[ArchivePropertiesStyle.rowBack, { height: rowAnimatedValues[rowKey].rowHeight }]}
    >
      {!rightActionActivated && (
        <TouchableWithoutFeedback onPress={onClose}>
          <Animated.View
            style={[
              ArchivePropertiesStyle.backBtn,
              ArchivePropertiesStyle.backLeftBtn,
              {
                width: 100,
                transform: [
                  {
          ...
          >
            <View style={ArchivePropertiesStyle.backBtnInner}>
              <Ionicons
                name="arrow-forward-outline"
                size={22}
                color={_COLORS.Kodie_BlackColor}
              />
              <Text style={ArchivePropertiesStyle.backBtnText}>Left</Text>
            </View>
          </Animated.View>
        </TouchableWithoutFeedback>
      )}
      {!leftActionActivated && (
        <TouchableWithoutFeedback onPress={onClose}>
          <Animated.View
            style={[
              ArchivePropertiesStyle.backBtn,
              ArchivePropertiesStyle.backRightBtn,
              ArchivePropertiesStyle.backRightBtnLeft,
              {
                width: 100,
                transform: [
                  {
          ...
          >
            <View style={ArchivePropertiesStyle.backBtnInner}>
              ...
              />
              <Text style={ArchivePropertiesStyle.backBtnText}>More</Text>
            </View>
          </Animated.View>
        </TouchableWithoutFeedback>
      )}
        ...
        <TouchableWithoutFeedback onPress={onDelete}>
          <Animated.View
            style={[
              ArchivePropertiesStyle.backBtn,
              ArchivePropertiesStyle.backRightBtn,
              ArchivePropertiesStyle.backRightBtnRight,
              {
          ...
          >
            <View style={ArchivePropertiesStyle.backBtnInner}>
              ...
              <Text style={ArchivePropertiesStyle.backBtnText}>Archive</Text>
            </View>
          </Animated.View>
        </TouchableWithoutFeedback>
      )}
  ...
  const VisibleItem = (props) => {
    ...
    return (
      <TouchableWithoutFeedback onPress={() => console.log("touched")}>
        <Animated.View
          style={[
            ArchivePropertiesStyle.rowFront,
            {
        ...
        >
          <View style={ArchivePropertiesStyle.Container}>
            {console.log(data.name)}
            <View style={ArchivePropertiesStyle.flat_MainView}>
              <View style={ArchivePropertiesStyle.flexContainer}>
                <Text style={ArchivePropertiesStyle.commontext}>{data.text}</Text>
              </View>

              <View style={ArchivePropertiesStyle.RightContainer}>
                <View
                  style={[
                    ArchivePropertiesStyle.buttonView,
                    {
                ...
                >
                  <View
                    style={[
                      ArchivePropertiesStyle.roundButton,
                      {
                        backgroundColor: data.isPosted
                  ...
                  <Text
                    style={[
                      ArchivePropertiesStyle.buttonText,
                      {
                        color: data.isPosted
                          ? _COLORS.Kodie_BlueColor
                          : data.isongoing
            ...
            <Text style={ArchivePropertiesStyle.commonMidtext}>{data.refno}</Text>
            <View style={ArchivePropertiesStyle.flat_MainView}>
              <View style={ArchivePropertiesStyle.flexContainer}>
                <View style={ArchivePropertiesStyle.propertyView}>
                  <View style={ArchivePropertiesStyle.flexContainer}>
                    <Text style={ArchivePropertiesStyle.tom}>Tom</Text>
                    <View style={ArchivePropertiesStyle.locationView}>
                      ...
                      />
                      <Text style={ArchivePropertiesStyle.locationText}>
              ...
              <View style={[ArchivePropertiesStyle.BudgetView]}>
                <View style={ArchivePropertiesStyle.flexContainer}>
                  <Text style={ArchivePropertiesStyle.bugetText}>{data.budget}</Text>

                  <Text style={ArchivePropertiesStyle.spend}>{data.spend}</Text>
                </View>
              </View>
            </View>
            {/* <DividerIcon /> */}
