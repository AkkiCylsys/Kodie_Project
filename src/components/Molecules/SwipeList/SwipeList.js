  ...
  return (
    <SwipeListView
      ...
      renderItem={(rowdata,rowmap, index) => (
        // <View style={SwiperListStyle.rowFront}>
      ...
      renderHiddenItem={(data, index) => (
        <View style={SwiperListStyle.rowBack}>
            <Text>Left</Text>
            <TouchableOpacity
                style={[SwiperListStyle.backRightBtn, SwiperListStyle.backRightBtnLeft]}
                onPress={() => closeRow(rowMap, data.item.key)}
            >
                <Text style={SwiperListStyle.backTextWhite}>More</Text>
            </TouchableOpacity>
            <TouchableOpacity
                style={[SwiperListStyle.backRightBtn, SwiperListStyle.backRightBtnRight]}
