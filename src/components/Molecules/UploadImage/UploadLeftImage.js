...
const UploadLeftImage = props => {
  ...
  const handleLeftImageSelection = images => {
    if (leftImage.length + images.length <= 4) {
      setLeftImage([...leftImage, ...images]);
      props.leftImage([...leftImage, ...images]);
    } else {
      Alert.alert(
    ...
    return (
      <>
        <TouchableOpacity
              ...
              if (Platform.OS === 'ios') {
                ...
                if (index == 0) {
                  ...
                  if (granted === PermissionsAndroid.RESULTS.GRANTED) {
                    ...
                    Alert.alert(
                      'Camera permission denied. Open settings to enable camera access.',
                      '',
                      [
                        {text: 'Cancel', style: 'cancel'},
                        {text: 'Open Settings', onPress: openAppSettings},
                  ...
                  if (granted === PermissionsAndroid.RESULTS.GRANTED) {
                    ...
                    Alert.alert(
                      'Gallery permission denied. Open settings to enable gallery access.',
                      '',
                      [
                        {text: 'Cancel', style: 'cancel'},
                        {text: 'Open Settings', onPress: openAppSettings},
          ...
          <TouchableOpacity
            style={UploadImageStyle.Bottomcontainer}
            // onPress={async() => {
            //   try {
            //     const granted = await PermissionsAndroid.request(
            //       PermissionsAndroid.PERMISSIONS.CAMERA,
